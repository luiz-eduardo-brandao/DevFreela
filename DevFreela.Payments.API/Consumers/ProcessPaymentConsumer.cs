...
namespace DevFreela.Payments.API.Consumers
{
    ...
    {
        private const string QUEUE = "Payment";
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += (sender, eventArgs) =>
            {
                ...
                var paymentApprovedEvent = new PaymentApprovedIntegrationEvent(paymentInfo.IdProject);
                var paymentApprovedJson = JsonSerializer.Serialize(paymentApprovedEvent);
